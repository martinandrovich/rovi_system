...
DIR_PKG_ROOT   = DIR_CURRENT + "/..";
DIR_SCRIPTS    = DIR_PKG_ROOT + "/scripts";
DIR_EXPORT_FIG = DIR_SCRIPTS + "/export_fig";
DIR_TESTS      = DIR_PKG_ROOT + "/tests";
...
function dir = get_experiment_dir(experiment_name)
%get_experiment_dir - Description
%
% Syntax: dir = get_experiment_dir(experiment_name)
%
% Long description
	
end

function dir = get_experiment_data_dir(experiment_name, timestamp)
	%get_experiment_dir - Description
	%
	% Syntax: dir = get_experiment_dir(experiment_name)
	%
